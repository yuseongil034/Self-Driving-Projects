...
1. Colab이란?
무료로 파이썬 코드를 작성하고 실행할 수 있는 웹 기반 도구

구글 계정만 있으면 누구나 사용 가능

코드와 **설명(마크다운)**을 섞어서 사용 가능

2. Colab 시작 방법
구글에 "Colab" 검색 또는 https://colab.research.google.com/ 접속

새 노트북 만들기 클릭

코드 셀 또는 텍스트 셀 추가해서 사용
...
위 표에 있는 마크다운 문법으로 글 작성

실행(Shift+Enter) 하면 예쁘게 보임

6. 파이썬 코드 실행 방법
코드 셀 선택

파이썬 코드 입력 (예: print("Hello Colab!"))

실행(Shift+Enter) 하면 결과가 아래에 나옴
